...
async def generate_quiz(
    ...
    return QuizDetail.model_validate(service.get_detail(quiz.id, current_user.id))
...
def list_course_quizzes(
    ...
    return [
        ...
        for quiz in QuizService(db).list_for_course(course_id, current_user.id)
    ]
...
def get_quiz(
    ...
    return QuizDetail.model_validate(QuizService(db).get_detail(quiz_id, current_user.id))
